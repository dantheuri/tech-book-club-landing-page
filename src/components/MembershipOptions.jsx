      ...
      <div className="w-full lg:max-w-[74rem] flex flex-col lg:items-center gap-16 px-4 sm:px-0 sm:pl-10">
        ...
        <div className="w-full flex flex-wrap lg:justify-center lg:items-center gap-6">
          <div className="w-full md:w-[21.25rem] lg:max-w-[17.875rem] lg:h-[358px] border rounded-lg p-6">
            ...
            <button className="mt-8 uppercase bg-[#FFF5EF] hover:bg-gradient-to-r from-[#FFE2D1] to-[#FFF5EF] hover:cursor-pointer border-2 rounded-lg font-martian font-semibold text-[1.125em] tracking-[-1px] w-full h-[63px]">
              Subscribe Now
            </button>
          </div>
          <div className="relative w-full md:w-[21.25rem] md:max-w-[21.875rem] h-[390px] border rounded-lg p-10 bg-[#FAF5F3] overflow-hidden">
            <img
              src={patternGlow}
              alt=""
              className="hidden sm:block absolute right-[-30%] top-[100%] transform -translate-y-1/2 w-full scale-150 h-full pointer-events-none z-0"
            />
