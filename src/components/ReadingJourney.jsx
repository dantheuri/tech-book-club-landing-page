...
const ReadingJourney = () => {
  return (
    <section className="flex justify-center bg-[#FAF5F3]">
      <div className="w-full lg:max-w-[1110px] flex flex-col lg:items-center px-4 sm:px-10 py-10 gap-16 rounded-xl">
        <h1 className="font-martian font-semibold text-[2em]/11 sm:text-[3.125em] leading-16 tracking-[-2px] lg:w-[15ch] lg:text-center">
        ...
        <div className="flex flex-col lg:flex-row gap-6 justify-around font-martian font-semibold text-lg/6 tracking-[-1px]">
          <div className="flex flex-col gap-4 lg:max-w-[14.156rem]">
            ...
            <img
              src={patternArrow}
              alt="Pattern Arrow"
              className="hidden lg:block absolute ml-35"
            />
          </div>
          <div className="flex flex-col gap-4 lg:max-w-[14.156rem]">
            <p className="flex justify-center items-center size-[40px] border-2 rounded-sm">
